...
class Managers extends CActiveRecord
{
	...
	*/
	...
	{
		$activeData = Managers::model()->findAll();
		$options = array();
	...
	public function rules()
	{
		...
		return array(
			array('name', 'required', 'message'=>'Поле {attribute} обязательно к заполнению'),
			array('name', 'length', 'max'=>64, 'tooLong'=> 'Поле {attribute} обязательно слишком длинное'),
